    ...
    <div class="container">
        <div class="row">
            <div class="card fondo">
                ...
                <br><br>
                    <div class="row">
                        <h4 class="card-title" style="margin-bottom: 2%;"> <strong class="color">Perfil</strong> <strong class="coloruno">Cuarto</strong></h4>
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <input type="text" class="form-control" id="floatingInput" placeholder="Imagen 360°">
                                <label for="floatingInput">Link Imagen 360°</label>
                            </div>
                        </div>
                    </div>
                    <br>
                    <h4 class="card-title"> <strong class="color">Datos</strong> <strong class="coloruno">Cuarto</strong></h4>
                    <br>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <label for="floatingSelect">ID de Propietario</label>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked">
                                <label class="form-check-label" for="flexCheckChecked">
                                    Aire Acondicionado ó abanico eléctrico
                                </label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Detalles de las normas y reglas de casa" id="floatingTextarea2" style="height: 100px"></textarea>
                                <label for="floatingTextarea2">Otros Servicios</label>
                            </div>
                        </div>
                    </div>
