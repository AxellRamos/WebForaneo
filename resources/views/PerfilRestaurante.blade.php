    ...
    <div class="container">
        <div class="row">
            <div class="card fondo">
                ...
                <br><br>
                    <div class="row">
                        <h4 class="card-title" style="margin-bottom: 2%;"> <strong class="color">Perfil</strong> <strong class="coloruno">Restaurante</strong></h4>
                        <div class="col-md-6">
                            <div class="col-md-12">
                                <input type="file" class="form-control" id="inputGroupFile01" style="">
                                <div id="emailHelp" class="form-text">Foto del Restaurante</div>
                            </div>
                        </div>
                    </div>
                    <br>
                    <h4 class="card-title"> <strong class="color">Datos</strong> <strong class="coloruno">del Restaurante</strong></h4>
                    <br>
                    <div class="row">
                        <div class="col-md-6">
